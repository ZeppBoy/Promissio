...
- Authorization denies unauthenticated and unauthorized operations in the single-tenant deployment; the proposed policy model requires explicit security review. See [authorization scope](../adr/0008-single-tenant-authorization.md).
