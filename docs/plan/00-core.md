# Promissio — Product context and target design

> Canonical roadmap context, consolidated 2026-09-10. This describes intent, not implementation status.
> [Current architecture](../architecture/current-state.md) and [status](../status.md) describe the working system.
> [AGENTS.md](../../AGENTS.md) governs operating rules and the locked stack; this plan does not override it.
...
- **.NET 9** (current), with a separately reviewed migration to .NET 10 planned.
